...
import org.cch.nanodb.LazyResultSetIterable;
...
class LazyResultSetIterableImpl<T> implements LazyResultSetIterable<T> {
    ...
    public LazyResultSetIterableImpl(PreparedStatement preparedStatement, RecordMapper<T> mapper) throws org.cch.nanodb.exceptions.SQLException {
    ...
    private class LazyResultSetIterator<T> implements Iterator<T>, Closeable {
        ...
        public LazyResultSetIterator(PreparedStatement preparedStatement, RecordMapper<T> mapper) throws org.cch.nanodb.exceptions.SQLException {
            this.preparedStatement = preparedStatement;
            try {
                this.resultSet = preparedStatement.executeQuery();
            } catch (SQLException ex) {
                throw new org.cch.nanodb.exceptions.SQLException("Failed to execute query", ex);
            }
            this.mapper = mapper;
        }
